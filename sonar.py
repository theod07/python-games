# Sonar demonstrates:
#	1. data structures
#	2. list method remove()
#	3. string method isdigit()
#	4. function sys.exit()
...
def showInstructions():
	print('''Instructions:
You are the captain of the SS Seeker, a treasure-hunting ship. Your current mission
...
represent distances of 2 away from the device. the 4's represent distances 
of 4 away from the device.
